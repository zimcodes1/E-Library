...
function Reading() {
    return (
        <div className="flex flex-col justify-between items-center mt-10 px-4">
            <h1 className="text-3xl max-[900px]:text-2xl text-gray-400 font-semibold mb-10">Maximize Your Potential</h1>
            
            <div className="flex max-sm:flex-wrap justify-between items-center w-full h-fit max-sm:py-5 flex-wrap gap-y-5">
