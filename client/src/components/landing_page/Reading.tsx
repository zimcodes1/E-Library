    ...
    return (
        <div className="flex flex-col justify-between items-center mt-20 max-[900px]:mt-10 max-sm:mt-5 px-4 max-sm:px-0">
            ...
            <div className="flex max-sm:flex-wrap justify-between items-center max-[900px]:mt-10 w-full mt-20 max-sm:mt-5 h-fit max-sm:py-5 flex-wrap gap-y-5">
                ...
                <div className="w-[32%] max-md:w-[48%] max-sm:w-full h-80 max-[900px]:h-fit flex justify-center items-center rounded-3xl flex-col backdrop-blur-2xl overflow-hidden px-8 max-[900px]:px-3 py-6 border bg-[#48576019] border-gray-800 text-center">
                    <i className="fa fa-calendar-check text-[#6842ae3a] text-8xl max-[900px]:text-6xl mb-4"></i>
                ...
                <div className="w-[32%] max-md:w-[48%] max-sm:w-full h-80 max-[900px]:h-fit flex justify-center items-center rounded-3xl flex-col backdrop-blur-2xl overflow-hidden px-8 max-[900px]:px-3 py-6 border bg-[#48576019] border-gray-800 text-center">
                    <i className="fa fa-clock text-[#6842ae3a] text-8xl max-[900px]:text-6xl mb-4"></i>
                ...
                <div className="w-[32%] max-md:w-full max-sm:w-full h-80 max-[900px]:h-fit flex justify-center items-center rounded-3xl flex-col backdrop-blur-2xl overflow-hidden px-8 max-[900px]:px-3 py-6 border bg-[#48576019] border-gray-800 text-center">
                    <i className="fa fa-graduation-cap text-[#6842ae3a] text-8xl max-[900px]:text-6xl mb-4"></i>
                ...
                <div className="w-[49%] max-sm:w-full mt-5 max-[900px]:mt-0 h-40 flex justify-center items-center rounded-3xl flex-col backdrop-blur-2xl overflow-hidden px-10 py-6 border bg-[#48576019] border-gray-800 text-center">
