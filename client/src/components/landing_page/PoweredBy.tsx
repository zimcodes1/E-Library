...
function PoweredBy() {
    return (
        <div className="flex flex-col justify-between items-center">
            <h1 className="text-3xl max-[900px]:text-2xl text-gray-400 font-semibold mb-5">Powered by:</h1>
            <div className="flex max-sm:flex-wrap gap-5 justify-evenly items-center w-full max-[900px]:w-full h-fit max-sm:h-fit rounded-2xl max-sm:py-5">
