...
function PoweredBy() {
    return (
        <div className="flex flex-col justify-between items-center mt-10">
            ...
            <div className="flex flex-wrap mt-20 max-sm:mt-0 max-sm:flex-wrap gap-5 max-sm:gap-0 justify-evenly items-center w-full max-[900px]:w-full h-fit max-sm:h-fit rounded-2xl">
