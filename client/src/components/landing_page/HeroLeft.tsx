    ...
    return (
        ...
        >
            ...
            <div className="flex max-sm:flex-col gap-4 mt-8">
                <Button icon="fa-arrow-right" text="Get Started" styles="px-8 py-3 text-base" />
                <Link to='/home'>
                    <Button icon="fa-user" text="Browse as Guest" styles="bg-gradient-to-r from-purple-600 to-purple-400 text-gray-50 border-none px-8 py-3 text-base hover:shadow-lg hover:shadow-purple-500/50" />
                </Link>
            </div>
        </motion.div>
    )
