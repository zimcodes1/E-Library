...
function HeroLeft() {
    return (
        <div className="w-full py-10 mt-20 max-sm:mt-10 max-sm:w-full h-full max-sm:h-fit max-sm:pt-15 flex flex-col justify-center items-center">
            ...
            {/* Quick Search */}
                <div className="w-100 max-sm:w-full max-sm:mx-auto h-13 border border-gray-500 flex justify-between items-center rounded-3xl shadow-xl mt-4 p-1">
                    <input type="text" placeholder="Search for a book..." className="w-[85%] h-full pl-4 rounded-l-2xl outline-0 focus:ring-0 caret-purple-600 text-gray-200" />
