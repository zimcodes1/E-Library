...
function HeroLeft() {
    return (
        ...
        >
            ...
            <p className="text-gray-400 text-lg max-sm:text-base mt-6 max-[900px]:text-center max-w-xl">
                Access thousands of books and resources from the comfort of your device. Read, learn, and grow.
            </p>
            
            <div className="w-full max-w-xl h-14 max-sm:h-12 border-2 border-purple-500/30 bg-[#31303e] flex justify-between items-center rounded-full shadow-lg shadow-purple-500/10 mt-8 p-1.5 hover:border-purple-500/50 transition">
                <input type="text" placeholder="Search for a book..." className="w-full h-full pl-5 bg-transparent rounded-l-full outline-0 focus:ring-0 caret-purple-500 text-gray-200 placeholder-gray-500" />
            ...
            <div className="flex max-sm:flex-col gap-4 mt-8">
                <Button text="Get Started" styles="px-8 py-3 text-base" />
                <Link to='/home'>
