...
function HeroLeft() {
    return (
        <div className="w-full py-10 mt-20 max-sm:w-full h-full max-sm:h-fit max-sm:pt-15 flex flex-col justify-center items-center">
            ...
            <p className="text-gray-500 text-md mt-5">Access Thousands of Books and Resources From the Comfort of Your Device.</p>
            {/* Quick Search */}
