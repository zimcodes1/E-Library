...
function HeroRight() {
	return (
		<motion.div
			...
			className="w-1/2 max-[900px]:w-full inset-0 max-sm:absolute h-fit flex justify-center items-center relative"
		>   
			<div className="relative w-full max-w-md aspect-square flex justify-center items-center">
				...
				<img
					...
					alt="Hero Image"
					className="relative w-4/5 max-sm:w-2/3 h-auto drop-shadow-2xl max-sm:*:opacity-50"
				/>
			</div>
		</motion.div>
	);
