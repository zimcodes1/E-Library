function ReadAnywhere() {
    return (
        <div className="flex flex-col justify-between items-center mt-20 px-4">
            <h1 className="text-3xl max-[900px]:text-2xl text-gray-400 font-semibold">Read Anywhere</h1>
            ...
            <div className="flex max-sm:flex-wrap justify-between items-center w-full mt-20 h-fit max-sm:py-5 flex-wrap gap-y-5">
                ...
                <div className="w-1/2 max-sm:w-full flex flex-col justify-center items-start h-100 bg-[#48576019] rounded-3xl border border-gray-800 p-10 backdrop-blur-xl">
