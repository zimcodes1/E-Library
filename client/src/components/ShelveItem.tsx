...
const ShelveItem = () => {
    return (
        <div className="flex justify-between items-center 2/10 h-fit p-2 rounded-2xl bg-[#4857600f] border border-gray-700">
            ...
            <span className="flex w-27 h-40 flex-col items-center justify-between text-gray-400">
                <span>
                    <p className="text-sm text-gray-300">Last Read <i className="fa fa-eye"></i></p>
