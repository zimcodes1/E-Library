function Footer() {
    return (
        <div className="w-full px-20 py-5 bg-blue-100 h-80 flex flex-col justify-evenly items-start">
            <div className="w-full h-3/4 flex justify-evenly items-start">
                <span className="w-1/4 flex flex-col items-start justify-center">
            ...
            <div className="w-full h-1/4 flex justify-center items-center">
                ...
                <span className="flex flex-col mx-10">
                    <img src="/images/playstore.png" className="w-auto h-10" alt="Google Play Store" />
                    <img src="/images/appstore.png" className="w-auto h-10" alt="Apple App Store" />
                </span>
            </div>
