...
function SignUp() {
	...
	return (
		...
		<div className="w-full flex justify-center items-center bgImage h-screen max-md:min-h-screen sm:pb-10 max-sm:h-dvh">
			{success && (
				<Message
					type="success"
			...
			<div className="w-[80%] max-[900px]:w-[60%] max-[900px]:h-200 max-sm:w-full max-sm:h-full max-sm:rounded-none h-[90%] border bg-[#48576019] max-sm:bg-transparent max-sm:border-none border-gray-800 rounded-3xl flex justify-between items-center overflow-hidden p-2">
				<div className="w-1/2 max-[900px]:w-full h-full flex flex-col items-start max-sm:items-center justify-start pt-10 max-sm:pt-0 pl-20 max-[900px]:pl-0 overflow-scroll no-scrollbar">
					<span className="w-full h-fit flex justify-start max-[900px]:justify-center items-center">
						...
						<h1 className="text-lg max-sm:text-3xl font-[Super] gradient">
							Libronet
						</h1>
					</span>

					{/* Changed text color to gray-50 to match Login header */}
					<span className="max-sm:mt-5 sm:mt-3 flex max-sm:justify-between max-md:hidden sm:justify-start w-full items-center">
						<img src="/images/logo.png" alt="Logo" className="w-10 sm:hidden" />
						<h1 className="text-3xl font-[Super] font-semibold text-gray-50 sm:mt-5 max-[900px]:mx-auto">
							<span className="max-sm:hidden">Welcome to </span>
							<br className="max-[900px]:hidden" />
							<span className="font-[Super] gradient">Libronet</span>
						</h1>
					</span>
					<p className="text-xs text-gray-400 mt-3 max-sm:mt-10 max-[900px]:mx-auto">
						Fill in your information to create your account.
					</p>

					<form
						onSubmit={handleSubmit}
						className="flex w-[60%] max-[900px]:mx-auto max-[900px]:w-[80%] pt-5 flex-col"
					>
						<span
							onClick={() => {
						...
						<span className="w-full flex justify-between items-center mt-7">
							...
							<span className="flex justify-between items-center">
								<img
									...
									alt="Continue With FB"
								/>
								<img
									src="/images/Gmail.png"
									className="w-10 h-auto mx-2 cursor-pointer"
									alt="Continue With Gmail"
								/>
							</span>
						</span>
					</form>
