            ...
            <div className="w-6/7 max-[900px]:w-7/8 max-sm:w-full min-h-screen flex flex-col px-10 max-[900px]:px-5 max-sm:px-3 pt-5 relative">
                ...
                <div className="w-full h-full flex mt-15 max-sm:mt-3 flex-col">
                    <span className="flex justify-start max-sm:justify-between max-sm:px-5 items-center">
                        ...
                        <span className="flex max-sm:max-w-40 h-9 min-w-25 px-2 ml-10 rounded-4xl bg-purple-500/5 justify-center items-center border border-purple-500/20 shadow cursor-pointer">
                            <CustomSelect 
