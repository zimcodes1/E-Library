...
function HomePage() {
	...
	return (
		<div className="w-full flex justify-end max-sm:items-start items-center bg-[#060410] min-h-screen max-sm:h-fit pb-20">
					...
					<div className="w-full h-150 max-sm:h-fit flex flex-col">
						...
						<div className="w-full h-fit mt-2 flex flex-col">
							{loadingRecommended ? (
								...
								<div
									className={`w-fit ${containerHeight[0]} overflow-hidden flex justify-evenly flex-wrap gap-3 max-[900px]:gap-2 max-sm:gap-1 transition-all duration-300`}
								>
						...
						<div className="w-full h-fit mt-2 flex flex-col">
							{loadingRecent ? (
								...
								<div className="w-full h-44 flex flex-col justify-center items-center gap-3">
                                    <i className="fa fa-book-open text-5xl text-gray-600"></i>
                                    <p className="text-gray-400 text-lg">No recent readings</p>
								</div>
							) : (
