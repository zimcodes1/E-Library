    ...
    <div className="w-full flex justify-end items-center bgImage min-h-screen pb-10 max-sm:pb-40">
      ...
      <div className="w-6/7 max-[900px]:w-8/9 max-sm:w-full min-h-screen flex flex-col px-10 max-[900px]:px-3 max-sm:px-3 pt-5 relative">
        ...
        <div className="w-full h-full max-sm:h-fit flex mt-15 max-sm:mt-3 flex-col">
          ...
          <div className="hidden w-9/10 max-sm:w-full max-sm:mx-auto h-13 border border-gray-700 max-sm:flex justify-between items-center rounded-3xl shadow-xl mt-4 p-1">
            <input
              type="text"
              placeholder="Search for a book..."
              className="w-[85%] h-full pl-4 rounded-l-2xl outline-0 focus:ring-0 caret-purple-600 text-gray-200"
            />
            <span className="w-13 bg-purple-50 h-full flex justify-center items-center rounded-full cursor-pointer">
              <i className="fa fa-search text-gray-800 text-lg"></i>
            </span>
          </div>
          ...
          <div className="w-full h-fit flex flex-col mt-5 text-gray-300 text-sm">
            <span className="w-full px-5 flex justify-start items-center">
              <span className="flex justify-start w-3/10 max-sm:w-4/10">
                <p>Title</p>
              </span>
              <span className="flex justify-center w-25">
                <p>Rating</p>
              </span>
              <span className="flex justify-center w-2/10">
                <p>Category</p>
              </span>
            ...
            <div className="w-full h-fit flex flex-col">
              <SearchElement
                bookImage="/images/books/books.jpeg"
                bookDetails={{
              ...
              ></SearchElement>
              <SearchElement
                bookImage="/images/books/book2.png"
                bookDetails={{
                  title: "Web Traffic Explosion",
                  author: "Jane Doe",
                  year: 2021,
                  rating: 3.2,
                  category: "Technology",
              ...
              ></SearchElement>
              <SearchElement
                bookImage="/images/books/audience.png"
                bookDetails={{
                  title: "Influencing Marketing",
                  author: "John Doe",
                  year: 2000,
                  rating: 4.3,
                  category: "Business",
