...
function LoginPage() {
	...
	return (
		<div className="w-full flex justify-center items-center bgImage h-screen max-sm:h-dvh">
			...
			<div
				className="w-[80%] max-[900px]:w-[60%] max-[900px]:h-200 max-sm:w-full max-sm:h-full
            max-sm:bg-transparent max-sm:rounded-none max-sm:m-0 max-[900px]:flex-col-reverse h-[90%]
            sm:border bg-[#48576019] border-purple-600/10 rounded-3xl max-sm:justify-end flex 
				...
				<div className="w-1/2 max-[900px]:pb-10 max-[900px]:w-full max-[900px]:h-fit max-sm:pb-20 h-full flex flex-col items-start justify-start max-sm:justify-center pt-10 max-[900px]:pt-0 pl-20 max-[900px]:pl-0">
					<span className="w-full h-fit flex justify-start max-[900px]:justify-center items-center">
						<img
							src="/images/logo.png"
							alt="Logo"
							className="w-10 max-sm:w-10"
						/>
						<h1 className="text-lg max-sm:text-3xl font-[Super] gradient">
							Libronet
						</h1>
					</span>
					<h1 className="text-3xl font-[Super] font-semibold text-gray-50 mt-5 max-[900px]:mx-auto max-[900px]:text-center max-sm:text-2xl">
						Holla Bookie, <br />
						Welcome Back
					</h1>
					<p className="text-xs text-gray-400 mt-3 max-[900px]:mx-auto">
						Hey, welcome back to your silent spot.{" "}
					</p>
					<form
						onSubmit={handleSubmit}
						className="flex w-[60%] max-[900px]:w-8/10 max-[900px]:mx-auto pt-10 max-sm:pt-5 flex-col"
					>
						<input
							type="text"
